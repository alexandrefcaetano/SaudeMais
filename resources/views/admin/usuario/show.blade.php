                    ...
                    <!--begin::Form-->
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <div class="visualizar">
                                        <label class="visualizar-titulo">Nome:</label>
                                        {{ $usuario->nome }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="visualizar">
                                            <label class="visualizar-titulo">Status</label>
                                            {!! $usuario->getStatusBadge() !!}
                                        </div>
                                    </div>
                                </div>´
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <div class="visualizar">
                                        <label class="visualizar-titulo">Username:</label>
                                        {{ $usuario->usuario }}
                                    </div>
                                </div>
                            </div>
