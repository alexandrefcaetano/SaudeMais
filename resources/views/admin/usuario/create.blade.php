        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('usuario.store') }}" class="kt-form kt-form--label-right form-usuario"  method="POST" novalidate="novalidate">
                        @csrf()
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Nome:</label>
                                    <input type="text" class="form-control" name="nome" required value="{{ old('nome') }}" placeholder="Nome">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status" required>
                                            ...
                                            <option value="BL"  {{ old('status') == 'BL' ? 'selected' : '' }}>Bloqueado</option>
                                            <option value="IN"  {{ old('status') == 'IN' ? 'selected' : '' }}>Inativo</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off"  name="usuario" required value="{{ old('usuario') }}" placeholder="Nome Usuário" aria-required="true">
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <label>Senha:</label>
                                    <input type="text" class="form-control" disabled  value="Saude@2025">
                                </div>
                            </div>
                        </div>
