        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('seguradora.store') }}" class="kt-form kt-form--label-right form-seguradora"  method="POST" novalidate="novalidate">
                        @csrf()
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Seguradora:</label>
                                    <input type="text" class="form-control" name="seguradora" required value="{{ old('seguradora') }}" placeholder="Seguradora">
                                    <span class="form-text text-muted">Entre com o nome da Seguradora...</span>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="status">Ativo:</label>
                                        <select class="form-control" id="status" name="ativo" required>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>NIF:</label>
                                    <input type="text" class="form-control" name="nif" required value="{{ old('nif') }}" placeholder="NIF">
                                    <span class="form-text text-muted">Entre com o numero do NIF...</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Endereço:</label>
                                    <input type="text" class="form-control" name="endereco" required value="{{ old('endereco') }}" placeholder="Endereço">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-2">
                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                        <label>
                                            <input type="checkbox" {{ old('exibirsite')  ? 'checked' : '' }} name="exibirsite">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                                ...
                                <div class="col-2">
                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                        <label>
                                            <input type="checkbox" {{ old('exibirdanoscorporais') ? 'checked' : '' }}  name="exibirdanoscorporais">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
...
<script>
    ...
    $(function () {
        ...
        $('.tabela-itens-atributo').bootstrapTable('load', {{$itensAtributo}} {{ old('endereco') }} );
    });
