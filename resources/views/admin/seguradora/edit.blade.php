        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('seguradora.update', $seguradora->id_cryto) }}" class="kt-form kt-form--label-right form-seguradora"  method="POST" novalidate="novalidate">
                        @csrf()
                        @method('PUT')
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="seguradora" required value="{{ $seguradora->seguradora }}" placeholder="Seguradora">
                                    <span class="form-text text-muted">Entre com o nome da Seguradora...</span>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="status">Ativo:</label>
                                        <select class="form-control" id="statuativos" name="ativo" required>
                                            <option value="">Selecione</option>
                                            <option value="S"  {{ $seguradora->ativo == 'S' ? 'selected' : '' }}>Sim</option>
                                            <option value="N"  {{ $seguradora->ativo == 'N' ? 'selected' : '' }}>Não</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>NIF:</label>
                                    <input type="text" class="form-control" name="nif" required value="{{ $seguradora->nif }}" placeholder="NIF">
                                    <span class="form-text text-muted">Entre com o numero do NIF...</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Endereço:</label>
                                    <input type="text" class="form-control" name="endereco" required value="{{ $seguradora->endereco }}" placeholder="Endereço">
                                    <span class="form-text text-muted">Entre com o Endereço ...</span>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-3 col-form-label">Exibir Site</label>
                                <div class="col-2">
                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                        <label>
                                            <input type="checkbox" {{$seguradora->exibirsite == 'S'  ? 'checked' : '' }} name="exibirsite">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                                <label class="col-3 col-form-label">Exibir Danos Corporais</label>
                                <div class="col-2">
                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                        <label>
                                            <input type="checkbox" {{ $seguradora->exibirdanoscorporais == 'S' ? 'checked' : '' }}  name="exibirdanoscorporais">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <table data-toggle="table" class="table table-bordered table-hover table-contato" data-unique-id="id">
                                        ...
                                        <tr>
                                            <th data-field="responsavel" data-align="center">Responsavel</th>
                                        ...
                                        <input type="hidden" name="contato" class="contato" value="{{ old('contato') }}" />
                                    </table>
                                </div>
                            </div>
...
<div class="modal fade" id="modal-contato" tabindex="-1" role="modal-contato" aria-labelledby="modal-contato" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form role="form" name="form-contato" class="kt-form kt-form--label-right form-contato" method="POST"
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" name="responsavel"  aria-required="true">
                            <span class="form-text text-muted">Entre com o responsavel</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="kt-radio-inline">
                                ...
                                <label class="kt-radio kt-radio--solid">
                                    <input type="radio" name="flg_principal"   value="F"> Não
                                    <span></span>
                                </label>
                            </div>
...
<script>
    ...
    $(function () {
        ...
        $(".form-contato").validate({
            ...
            submitHandler: function (form) {
                ...
                let row2 = {
                    responsavel: $(form).find('[name=responsavel]').val(),
        ...
        $('.table-contato').bootstrapTable('load', <?= $seguradora->contato ?>);
    });
    ...
    function limparCamposModal() {
        ...
        form.find('[name=responsavel]').val('');
        form.find('[name=tipo]').val('');
        form.find('[name=tipo_contato]').val('');
        form.find('[name=descricao]').val('');
        form.find('[name=flg_principal]').prop('checked', false);
    }
