        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('empresa.update',  $empresa->id_cryto) }}" class="kt-form kt-form--label-right form-empresa"  method="POST" novalidate="novalidate">
                        @csrf()
                        @method('PUT')
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="razaosocial" minlength="2" maxlength="150" required value="{{ $empresa->razaosocial }}" placeholder="Razão Social">
                                    <span class="form-text text-muted">Entre com o nome Razão Social...</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Nome Fantasia:</label>
                                    <input type="text" class="form-control" name="nomefantasia" minlength="2" maxlength="150" required value="{{ $empresa->nomefantasia }}" placeholder="Nome Fantasia">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>NIF:</label>
                                    <input type="text" class="form-control" name="nif" minlength="2" maxlength="50" required value="{{ $empresa->nif }} " placeholder="NIF">
                                    <span class="form-text text-muted">Entre com o NIF...</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Ramo de Atividade:</label>
                                    <input type="text" class="form-control" name="ramoatividade" minlength="2" maxlength="150" required value="{{ $empresa->ramoatividade }}" placeholder="Ramo Atividade">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="ativo" name="ativo" required>
                                            ...
                                            <option value="S"  {{ $empresa->ativo == 'S' ? 'selected' : '' }}>Sim</option>
                                            <option value="N"  {{ $empresa->ativo == 'N' ? 'selected' : '' }}>Não</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="visualizarrelatendimento" name="visualizarrelatendimento" required>
                                            ...
                                            <option value="S"  {{ $empresa->visualizarrelatendimento == 'S' ? 'selected' : '' }}>Sim</option>
                                            <option value="N"  {{ $empresa->visualizarrelatendimento == 'N' ? 'selected' : '' }}>Não</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="seguradora" name="seguradora" required>
                                            ...
                                            @forelse ($seguradoras as $seguradora)
                                                <option value="{{ $seguradora->encrypted_id }}" {{ $seguradora->id_seguradora == $empresa->seguradora_id ? 'selected' : '' }}>{{ $seguradora->seguradora }}</option>
                                            @empty
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>Morada:</label>
                                    <input type="text" class="form-control" name="morada" minlength="2" maxlength="200" required value="{{ $empresa->morada }}" placeholder="Morada">
                                    <span class="form-text text-muted">Entre com a Morada...</span>
                                </div>
                                <div class="col-lg-4">
                                    <label>Corretor:</label>
                                    <input type="text" class="form-control" name="corretor" minlength="2" maxlength="50" required value="{{ $empresa->corretor }}" placeholder="Ramo Atividade">
                                    <span class="form-text text-muted">Entre com o Corretor...</span>
                                </div>
                            </div>
                            <div class="form-group form-group-last">
                                <label for="exampleTextarea">Observação:</label>
                                <textarea class="form-control" id="observacao" name="observacao" {{ old('observacao') }} rows="3">{{ $empresa->observacao }}</textarea>
                            </div>
...
<script>
    ...
    $(function () {
        ...
        $('.table-contato').bootstrapTable('load', <?= $empresa->contato ?>);
    });
