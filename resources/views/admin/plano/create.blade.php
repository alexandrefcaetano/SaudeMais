        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('plano.store') }}" class="kt-form kt-form--label-right form-plano"  method="POST" novalidate="novalidate">
                        @csrf()
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Valor:</label>
                                    <input type="text" class="form-control" name="valor" required value="{{ old('valor') }}" placeholder="VALOR">
                                    <span class="form-text text-muted">Entre com o Valor...</span>
                                </div>
                                <div class="col-lg-6">
                                    <label>Validade:</label>
                                    <input type="text" class="form-control" name="validade" required value="{{ old('validade') }}" placeholder="Valiade">
