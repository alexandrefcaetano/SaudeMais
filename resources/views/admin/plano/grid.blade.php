            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <a href="{{ route('plano.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plano" value="{{ old('plano', request('plano')) }}" class="form-control" placeholder="Search... Nome Plano" id="generalSearch">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="kt-datatable__pager-info">
                                        <div class="dropdown bootstrap-select kt-datatable__pager-size" >
                                                <form method="GET" action="{{ route('plano.index') }}">
                                        ...
                                        <span class="kt-datatable__pager-detail" style="margin-left: -35px"> de {{ $planos->total() }} registros.</span>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="kt-portlet__head-actions">
                                                <a href="{{ route('plano.show', encrypitar( $plano->id_plano)) }}" data-skin="dark" data-toggle="kt-tooltip" class="btn btn-outline-success btn-sm btn-icon btn-icon-md" data-original-title="Visualizar">
                                                    <i class="flaticon2-search-1"></i>
                                                </a>
                                                <a href="{{ route('plano.edit', encrypitar( $plano->id_plano)) }}" data-skin="dark" data-toggle="kt-tooltip" class="btn btn-outline-warning btn-sm btn-icon btn-icon-md" data-original-title="Editar">
