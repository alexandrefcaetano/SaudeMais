        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('especialidade.store') }}" class="kt-form kt-form--label-right form-especialidade"  method="POST" novalidate="novalidate">
                        @csrf()
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Especialidade:</label>
                                    <input type="text" class="form-control" name="especialidade" required value="{{ old('especialidade') }}" placeholder="Especialidade">
