        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('medico.update', $medico->id_cryto) }}" class="kt-form kt-form--label-right form-medico"  method="POST" novalidate="novalidate">
                        @csrf()
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label>Nome:</label>
                                    <input type="text" class="form-control" name="medico" required value="{{ $medico->medico }}" placeholder="Medico">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipo" name="tipo" required>
                                            ...
                                            <option value="M" @if($medico->tipo == 'M') selected @endif>Especialista</option>
                                            <option value="T" @if($medico->tipo == 'T') selected @endif>Triagem</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="crm" required value="{{ $medico->crm }}" placeholder="CRM/ORMED">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="especialidade" name="especialidade" required>
                                            ...
                                            @foreach($especialidades as $especialidade)
                                                <option value="{{ $especialidade->id_cryto }}"
                                                    {{ in_array($especialidade->id_especialidade, $medico->especialidades->pluck('id_especialidade')->toArray()) ? 'selected' : '' }}>
...
<script>
    ...
    $(function () {
        ...
        $('.tabela-contato').bootstrapTable('load', <?= $medico->contato ?>);
    });
    ...
    function limparCamposModal() {
        ...
        form.find('[name=crm]').val('');
        form.find('[name=especialidade]').val('');
    }
