...
class RelatorioPrecoPrestadoresExport implements FromView, WithDrawings, WithTitle
{
    ...
    public function view(): View
    {
        try {
            ...
            $relatorio_preco_prestador = DB::select(utf8_decode(""));

            return view('exports.relatorio_preco_prestador', [
                'relatorio_preco_prestador' => $relatorio_preco_prestador
            ]);
        } catch (Exception $e) {
            report($e);
            return view('exports.relatorio_preco_prestador', [
                'relatorio_preco_prestador' => [],
